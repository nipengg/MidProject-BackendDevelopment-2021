    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="age" class="block mt-1 w-full" type="number" name="age" required autocomplete="age" />
            </div>

            <div class="mt-4">
                <x-jet-label for="birth_date" value="{{ __('Birth Date') }}" />
                <x-jet-input id="birth_date" class="block mt-1 w-full" type="date" name="birth_date" required autocomplete="birth_date" />
            </div>
